...
Route::middleware('admin')->group(callback: function () {
    ...
    Route::post('/update_category/{id}', [AdminController::class, 'postUpdateCategory'])->name(name: 'admin.postupdatecategory');
    ...
    Route::post('/search', [AdminController::class, 'searchProduct'])->name(name: 'admin.searchproduct');
});
